...
render_view("inventory","set_category");
...
elseif(isset($_POST['get_category']))
{
  if($_POST['get_category'] == "")
  {
    ...
    echo "<script> window.location.href='".url()."/src/add_quantity.php'; </script>";
  }
  else
  {
    ...
    render_view("headers","header");
    echo "<br><br><br><br><br>";
    render_view("inventory","add_quantity");
    render_view("headers","footer");
    form_close();
  }
}
 ...
 <?php
     ...
     if(isset($_POST['update_quantity']))
     {
      ...
      if(!$check1)
      {
        ...
        $update_product_quantity = "CALL UpdateQuantity('".$_POST['update_table']."','".$_POST['selected_product']."',".$_POST['quantity'].",'".$_POST['selected_brand']."','".$_POST['selected_spl']."',".$_POST['numbers'].")";
